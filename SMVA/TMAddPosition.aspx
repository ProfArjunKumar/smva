<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TMAddPosition.aspx.cs" Inherits="SMVA.TMAddPosition" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>TEAM MEMBER ADD POSITION</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="myNavbar">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <asp:Button ID="btn_logout" runat="server" Text="LOGOUT" CssClass="btn btn-danger navbar-btn" UseSubmitBehavior="false" CausesValidation="false" OnClick="btn_logout_Click1" />
                        </ul>
                    </div>
                </div>
            </nav>
