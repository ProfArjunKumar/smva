...
namespace SMVA
{
    public partial class AddClient : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("insert into addclient(date,companyname,contactperson,desgination,mobile,alternativenumber,address,emailid,industry,gstdetail,billingaddress,aggrementdate,renewaldate,aggrementpercentage,contactperson2,desgination2,mobile2,contactperson3,desgination3,mobile3,contactperson4,desgination4,mobile4,contactperson5,desgination5,mobile5) values('" + txtdate.Text + "','" + txtcompanyname.Text + "','" + txtcontactnumber.Text + "','" + txtdesignation.Text + "','" + txtmobile.Text + "','" + txtalternativenumber.Text + "','" + txtaddress.Text + "','" + txtemailid.Text + "','" + txtindustry.Text + "','" + txtgst.Text + "','" + txtbiiling.Text + "','" + txtaggrementdate.Text + "','" + txtrenewaldate.Text + "','" + txtaggrementpercentage.Text + "','" + txtcontactperson2.Text + "','" + txtdesignation2.Text + "','" + txtmobile2.Text + "','" + txtcontactperson3.Text + "','" + txtdesignation3.Text + "','" + txtMobile3.Text + "','" + txtcontactperson4.Text + "','" + txtdesignation4.Text + "','" + txtMobile4.Text + "','" + txtcontactperson5.Text + "','" + txtdesignation5.Text + "','" + txtMobile5.Text + "')", con);
            con.Open();
