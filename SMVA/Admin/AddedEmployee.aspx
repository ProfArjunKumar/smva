<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddedEmployee.aspx.cs" EnableEventValidation="false" Inherits="SMVA.Admin.AddedEmployee" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ADDED EMPLOYEES</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <nav class="navbar navbar-inverse" style="background-color: #000099; border-color: #000099; width:100%">
...
<%--                        <script type="text/javascript" src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js"></script>--%>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:smva %>" SelectCommand="SELECT * FROM [addemployee]"></asp:SqlDataSource>
            <br />
             <br />
                    <br />
                    <br />
