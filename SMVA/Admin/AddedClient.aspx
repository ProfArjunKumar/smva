<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddedClient.aspx.cs" EnableEventValidation="false" Inherits="SMVA.Admin.AddedClient" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ADDED CLIENTS</title>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <br />
             ...
             <h3 style="text-align: center; color: darkblue;">Client Report</h3>
            <br />
            <br />
            <br />
            <br />
            ...
            <asp:GridView ID="GridView1" RowStyle-width="80px" RowStyle-Height="40px" HeaderStyle-Width="80px" HeaderStyle-Height="40px" runat="server" ClientIDMode="Static" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlDataSource1" CellPadding="4" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px">
                <Columns>
...
<%--                        <script type="text/javascript" src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>--%>
              ...
              <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:smva %>" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [addclient]">
            </asp:SqlDataSource>
