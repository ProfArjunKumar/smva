<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="Positions.aspx.cs" Inherits="SMVA.Admin.Positions" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <br />
              ...
              <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:smva %>" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [addposition]">
            </asp:SqlDataSource>
             <h3 style="text-align: center; color: darkblue;">Position Report</h3>
            <br />
            <br />
            <br />
           <div class="col-md-12">
            ...
            <div class="row col-md-offset-0" style="width:70%;">
