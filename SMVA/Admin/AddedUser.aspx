<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="AddedUser.aspx.cs" Inherits="SMVA.Admin.AddedUser" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <br />
             ...
             <h3 style="text-align: center; color: darkblue;">User Report</h3>
<br />
<br />
<br />
            ...
            <asp:GridView ID="GridView1" RowStyle-width="80px" RowStyle-Height="40px" HeaderStyle-Width="80px" HeaderStyle-Height="40px" runat="server" ClientIDMode="Static" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlDataSource1" CellPadding="4" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px">
                <Columns>
...
<HeaderStyle Height="40px" Width="100px" BackColor="#003399" Font-Bold="True" ForeColor="#CCCCFF"></HeaderStyle>

                <PagerStyle BackColor="#99CCCC" ForeColor="#003399" HorizontalAlign="Left" />

<RowStyle Height="40px" Width="100px" BackColor="White" ForeColor="#003399"></RowStyle>
...
<%--                        <script type="text/javascript" src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js"></script>--%>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:smva %>" SelectCommand="SELECT * FROM [adduser]"></asp:SqlDataSource>
            <br />
             <br />
                    <br />
                    <br />
